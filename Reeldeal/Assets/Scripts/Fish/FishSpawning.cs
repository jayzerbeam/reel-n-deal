...
public class FishSpawning : MonoBehaviour
{
    ...
    private void spawnFish()
    {
        ...
        fish.transform.position = new Vector3(fish.transform.position.x, randomWaterCollider.bounds.max.y - FishRenderer.bounds.size.y / 4, fish.transform.position.z); // half body in water
        spawnPosition = new Vector3(fish.transform.position.x, randomWaterCollider.bounds.max.y - FishRenderer.bounds.size.y / 4, fish.transform.position.z);
